...
int i=0, year[100], mate[100], espa[100], ciencias[100], est[100], nota[100];
...
void ingresodatos()
{
	...
	do{
	   ...
	   SetConsoleTextAttribute (hConsoleHandle, 15);
		gotoxy(12,10);cout << " Ingrese la fecha de nacimiento del estudiante " ;
       cin >> year[i];
	   ...
	   SetConsoleTextAttribute (hConsoleHandle, 15);
		gotoxy(12,22);cout << " Ingrese la nota de admision del examen de la UTC: ";
	   cin >> nota[i];
...
int promediocole()
{
	promedioc = mate[i] + espa[i] + ciencias[i] + est[i];
...
void resultados()
{
	...
	gotoxy (3,3); cout << "****** Resultados del Estudiante ******" <<endl;
	
	gotoxy (4,6); cout << " Cedula del estudiante " << cedula[i] <<endl;
	gotoxy (4,7); cout << " Nombre del estudiante " << nombre[i] <<endl;
	gotoxy (4,8); cout << " Fecha de nacimiento del estudiante " << year[i] <<endl;
	gotoxy (4,9); cout << " Edad del estudiante " << Edad() <<endl; // *******Disculpas, la edad sale en negativo*******
	gotoxy (4,10); cout << " Promedios de las materias del estudiante " <<endl;
	gotoxy (4,11); cout << " Matematicas: " << mate[i] <<endl;
	gotoxy (4,12); cout << " Espanol: " << espa[i] <<endl;
	gotoxy (4,13); cout << " Ciencias: " << ciencias[i] <<endl;
	gotoxy (4,14); cout << " Estudios sociales: " << est[i] <<endl;
	gotoxy (4,15); cout << " Promedio colegio del estudiante " << promediocole() <<endl;
	gotoxy (4,16); cout << " Porcentaje criterio colegio del estudiante " << porcentajecc() <<endl;
	gotoxy (4,17); cout << " Porcentaje Examen admision del estudiante " << porcentajead() <<endl;
	gotoxy (4,18); cout << " Promedio admision del estudiante " << promedioad() <<endl;
